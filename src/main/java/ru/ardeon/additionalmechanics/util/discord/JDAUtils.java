...
public class JDAUtils {
    ...
    public static void reactAndDelete(String reaction, Message message, FileConfiguration configs) {
        ...
        if (message.getChannelType() == ChannelType.TEXT && configs.getBoolean("deleteCommands", false)) {
            message.delete().queueAfter(configs.getInt("deleteAfter", 20), TimeUnit.SECONDS);
        }
    }
