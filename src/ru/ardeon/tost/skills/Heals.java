...
public class Heals {
	...
	public static void Holy(PlayerInteractEvent e)
	{
	...
	public static void Honey(PlayerInteractEvent e)
	{
		Player player = e.getPlayer();
		World world = player.getWorld();
	...
	public static boolean FirstAid(PlayerInteractEvent e)
	{
		Player player = e.getPlayer();
		World world = player.getWorld();
